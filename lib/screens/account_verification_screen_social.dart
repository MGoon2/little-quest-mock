...
import '../features/account_verification/models/social_account_verification_data.dart';
...
import '../features/account_verification/widgets/social_verification_card.dart';
...
class AccountVerificationScreenSocial extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final verificationData = data ?? const SocialAccountVerificationData(
      providers: [
        AuthProvider.google,
        AuthProvider.apple,
        AuthProvider.naver,
