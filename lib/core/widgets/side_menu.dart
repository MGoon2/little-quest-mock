...
class SideMenuItem {
  ...
  const SideMenuItem({required this.icon, required this.label, this.onTap});
}
    ...
    return Stack(
      children: [
        ...
        SlideTransition(
          ...
          child: Align(alignment: Alignment.centerLeft, child: _buildPanel()),
        ),
      ],
    );
  }
          ...
          Row(
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Little Quest', style: AppTextStyles.logo),
                  Text(
                    '자연 탐험 도감',
